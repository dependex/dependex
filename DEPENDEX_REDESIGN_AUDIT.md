...
| `_footer.php` | Piede di pagina globale | Contatti chiari (WhatsApp Grazia Nicosia, email governance) | Molti link accatastati, elementi commerciali (crociere, KDP) sovradimensionati | Riorganizzare con gerarchia chiara, human touch e rispetto della privacy |
