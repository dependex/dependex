...
$pageTitle = 'Organigramma della Rete dei Club · Rete Nazionale Hudolin';
$metaDesc = 'Esplora la struttura ecologico-sociale della Rete dei Club Hudolin. Visualizzazione interattiva: famiglie e club al vertice, supportati da ACAT, ARCAT e AICAT.';
$canonicalUrl = 'https://' . ($brand['domain'] ?? 'dependex.social') . '/organigramma.php';

$breadcrumbs = [
    'Home' => '/',
    'Rete & Territorio' => 'world-club-explorer.php',
    'Organigramma della Rete' => 'organigramma.php'
];
...
<style>
/* ==========================================================================
   ORGANIGRAMMA DELLA RETE DEI CLUB — STILI DEDICATI
   ========================================================================== */
:root {
  --tree-bg: #07090f;
...
<div style="max-width: 1440px; margin: 0 auto; padding: 1.5rem 1rem 3rem;">
  ...
  <div style="text-align: center; margin-bottom: 1.5rem;">
    ...
    <h1 style="font-size: clamp(1.6rem, 3.2vw, 2.4rem); font-weight: 850; color: #FFFFFF; margin: 0 0 0.5rem; letter-spacing: -0.02em;">
      Organigramma della Rete dei Club
    </h1>
  ...
  <div class="tree-container-wrapper" id="treeWrapper">
    ...
    <div class="tree-toolbar">
      ...
      <div class="tree-btn-group">
        <button type="button" class="tree-btn active" id="btnModeInverted" title="Vista Verticale (Famiglie in alto, AICAT di supporto in basso)">
          <?=dx_icon('arrow-down', '', 14)?> Vista Verticale
        </button>
...
(function(){
  ...
  function renderTree(sourceNode) {
    ...
    if (currentLayoutMode === 'inverted') {
      ...
      // Invertiamo l'asse Y per posizionare le Famiglie in alto e l'AICAT in basso
      rootNode.each(d => {
  ...
  // Helpers posizionamento testo per vista stella, vista verticale e rete
  ...
  function resetView() {
    ...
    if (currentLayoutMode === 'inverted') {
      // In vista verticale posizioniamo AICAT in basso al centro
